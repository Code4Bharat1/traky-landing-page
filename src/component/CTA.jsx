      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          >
            ...
            productivity with Traky. Start your free trial today and experience
            the difference.
          </motion.p>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-8 text-purple-100"
          >
