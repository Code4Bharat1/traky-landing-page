  ...
  const values = [
    {
      ...
      description:
        "We're on a mission to help people and teams achieve more by simplifying task management and boosting productivity.",
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "User-Centric",
      description:
        "Every feature we build starts with understanding our users' needs and challenges in their daily workflow.",
    },
    {
      icon: <Lightbulb className="w-8 h-8" />,
      title: "Innovation First",
      description:
        "We leverage cutting-edge technology like AI to create intelligent solutions that adapt to how you work.",
    },
    {
      icon: <Heart className="w-8 h-8" />,
      title: "Built with Care",
      description:
        "We craft every detail with attention and care, ensuring a delightful experience in every interaction.",
    },
  ];
  ...
  <span className="block bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
    task management
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            multiple task management tools that were either too simple or
            overwhelmingly complex. We set out to create the perfect balance:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                It started with a simple observation: most productivity tools
                were built by engineers, for engineers. They were powerful but
                intimidating, feature-rich but cluttered.
              </p>
              <p>
                We believed there was a better way. A tool that could harness
                the power of AI and modern technology while maintaining the
                simplicity and elegance that users actually want.
              </p>
              <p>
                Today, Traky is used by over 50,000 professionals across 150
                countries, from solo entrepreneurs to Fortune 500 companies. But
