      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center space-x-4 mb-12">
            <span
              className={`text-lg font-medium ${!isAnnual ? "text-blue-600" : "text-gray-500"}`}
            >
              Monthly
            </span>
            <button
            ...
            return (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <button
                    className={`w-full py-4 px-6 rounded-full font-semibold transition-all duration-200 mb-8 ${
                      plan.popular
