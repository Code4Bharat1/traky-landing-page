...
import { Eye, EyeOff, CheckSquare, ArrowLeft, Mail, Lock, User } from 'lucide-react';
...
const Login = ({ onNavigate }) => {
  ...
  return (
    <section id="login" className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 flex items-center justify-center py-12 px-4 relative">
      {/* Background Elements */}
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200"
            >
